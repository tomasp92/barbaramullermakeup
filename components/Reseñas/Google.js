...
export default function Google() {
    return (
        <div className={styles.reseñasgoogle} id="reseñasgoogle">
            ...
            <br />
            <div className={styles.fotosreseñas}>
                <a href="https://goo.gl/maps/iy8hWWSUUF9Cn1GbA" target="_blank">
                    <Image width={500} height={200} src="/images/reseñas/reseña_google1.jpg" />
                </a>
            </div>
            <div className={styles.fotosreseñas}>
                <a href="https://goo.gl/maps/V49S2qdqkH8tiAeS8" target="_blank">
            ...
            <br />
            <div className={styles.fotosreseñas}>
                <a href="https://goo.gl/maps/ScpwbVBNWWaUySoEA" target="_blank">
